 ...
 * ETL Replace Column
 *
 * @cli hadoop jar flamingo2-mapreduce-hadoop2-2.0.5-job.jar replace_column --input <INPUT> --output <OUTPUT> --inputDelimiter ',' --outputDelimiter '|' --columnSize 12 --columnsToReplace 1,2,3 --fromColumnsValues 'a,b,c' --toColumnsValues 'apple,banana,cloud'
...
Ext.define('Flamingo.view.workflowdesigner.property.etl.ETL_REPLACE_COLUMN', {
    extend: 'Flamingo.view.workflowdesigner.property._NODE_ETL',
    alias: 'widget.ETL_REPLACE_COLUMN',
    ...
    items: [
        {
            ...
            items: [
                ...
                {
                    xtype: 'textfield',
                    fieldLabel: message.msg('workflow.etl.column.columnsToReplace'),
                    name: 'columnsToReplace',
                    emptyText: message.msg('workflow.etl.column.columnsToReplaceEmpty'),
                    regex: /^\d+(,\d+)*$/,
                    allowBlank: false
                },
                {
                    xtype: 'textfield',
                    fieldLabel: message.msg('workflow.etl.column.fromColumnsValues'),
                    name: 'fromColumnsValues',
                    emptyText: message.msg('workflow.etl.column.fromColumnsValuesEmpty'),
                    allowBlank: false
                },
                {
                    xtype: 'textfield',
                    fieldLabel: message.msg('workflow.etl.column.toColumnsValues'),
                    name: 'toColumnsValues',
                    emptyText: message.msg('workflow.etl.column.toColumnsValuesEmpty'),
                    allowBlank: false
                }
            ]
        },
    ...
    afterPropertySet: function (props) {
        ...
        props.mapreduce.params.push('--columnsToReplace', '\'' + props.columnsToReplace + '\'');
        props.mapreduce.params.push('--fromColumnsValues', '\'' + props.fromColumnsValues + '\'');
        props.mapreduce.params.push('--toColumnsValues', '\'' + props.toColumnsValues + '\'');
