...
/**
 * ETL Text to sequence
 *
 * @cli hadoop jar flamingo2-mapreduce-hadoop2-2.0.5-job.jar textToSeq --input <INPUT> --output <OUTPUT>
...
Ext.define('Flamingo.view.workflowdesigner.property.etl.ETL_TEXT_TO_SEQ', {
    extend: 'Flamingo.view.workflowdesigner.property._NODE_ETL',
    alias: 'widget.ETL_TEXT_TO_SEQ',
