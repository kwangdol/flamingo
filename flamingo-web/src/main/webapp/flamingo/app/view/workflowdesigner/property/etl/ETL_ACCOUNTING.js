 ...
 * ETL Accounting
 *
 * @cli hadoop jar flamingo2-mapreduce-hadoop2-2.0.5-job.jar accounting --input <IN> --output <OUT> --inputDelimiter ',' --outputDelimiter ',' --columnSize 2 --expression '$1+$2'
...
Ext.define('Flamingo.view.workflowdesigner.property.etl.ETL_ACCOUNTING', {
    extend: 'Flamingo.view.workflowdesigner.property._NODE_ETL',
    alias: 'widget.ETL_ACCOUNTING',
    ...
    items: [
        {
            ...
            items: [
                ...
                {
                    xtype: 'textfield',
                    fieldLabel: message.msg('workflow.etl.accounting.expression'),
                    name: 'expression',
                    allowBlank: false
                }
            ]
    ...
    afterPropertySet: function (props) {
        ...
        props.mapreduce.params.push('--expression', '\'' + props.expression + '\'');
