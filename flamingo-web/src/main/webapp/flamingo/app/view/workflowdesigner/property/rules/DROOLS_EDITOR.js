 ...
 * Drools Rule Editor
 *
 * @cli hadoop jar flamingo2-mapreduce-hadoop2-2.0.5-job.jar drools --input <INPUT> --output <OUTPUT> --delimiter ',' --columnNames 'name,product,id' --encodedRule 'import%20java.util.HashMap%3B%0A%0Adialect%20%22mvel%22%0A%0Arule%20%22rule-1-1%22%0A%09no-loop%0A%09when%0A%09%09t%20%3A%20HashMap%28%20id%20%3D%3D%20%221%22%20%29%0A%09then%0A%09%09t.result%20%3D%20%22rule-1-1%22%20+%20t.id%3B%0Aend' --deleteOutput true
...
Ext.define('Flamingo.view.workflowdesigner.property.rules.DROOLS_EDITOR', {
    extend: 'Flamingo.view.workflowdesigner.property._NODE_ETL',
    alias: 'widget.DROOLS_EDITOR',
    ...
    afterPropertySet: function (props) {
        ...
        props.mapreduce.params.push("--encodedRule", '\'' + escape(props.script) + '\'');
