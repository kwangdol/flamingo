...
/**
 * ETL UIMA Application
 *
 * @cli hadoop jar flamingo2-mapreduce-hadoop2-2.0.5-job.jar uima --input <INPUT> --output <OUTPUT>
...
Ext.define('Flamingo.view.workflowdesigner.property.etl.ETL_UIMA_APP', {
    extend: 'Flamingo.view.workflowdesigner.property._NODE_ETL',
