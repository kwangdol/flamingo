...
Ext.define('Flamingo.view.workflowdesigner.property.ankus.ALG_ANKUS_CERTAIN_FACTOR_SUM', {
            ...
            items: [
                {
                    ...
                    tooltip: 'Numeric Properties List (For multiple, use a comma to distinguish. For all, use "-1."',
                ...
                },
                {
                    xtype: 'textfield',
                    name: 'cfsumMax',
                    fieldLabel: 'Max Value For Certainty Factor Sum',
                    allowBlank: true
                },
                {
