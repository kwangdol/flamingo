...
Ext.define('Flamingo.view.workflowdesigner.property.ankus.ALG_ANKUS_CF_ITEM_RECOMMEND', {
                    ...
                    items: [
                        {
                            ...
                            value: 'item',
                            flex: 1,
                            tooltip: 'For calculating similarities, select user-based of item-based.',
                            forceSelection: true,
                            multiSelect: false,
                            disabled: false,
                            editable: false,
                            ...
                            store: Ext.create('Ext.data.Store', {
                                ...
                                data: [
                                    {name: 'ITEM', value: 'item', description: 'Item Based'}
                                ]
                            })
                        }
                    ]
