...
Ext.define('Flamingo.view.workflowdesigner.property.ankus.ALG_ANKUS_CORR_NUMERIC', {
                    ...
                    items: [
                        {
                            ...
                            store: Ext.create('Ext.data.Store', {
                                ...
                                data: [
                                    ...
                                    {
                                        name: 'MAHATTAN DISTANCE',
                                        value: 'mahattan',
                                        description: 'MAHATTAN DISTANCE'
                                    },
                                    {
