...
/**
 * Expression MVEL File
 *
 * @cli hadoop jar flamingo2-mapreduce-hadoop2-2.0.5-job.jar mvel --input <INPUT> --output <OUTPUT> --scriptPath <PATH> --deleteOutput true
...
Ext.define('Flamingo.view.workflowdesigner.property.rules.MVEL_FILE', {
    extend: 'Flamingo.view.workflowdesigner.property._NODE_ETL',
    alias: 'widget.MVEL_FILE',
    ...
    afterPropertySet: function (props) {
        ...
        props.mapreduce.params.push("--scriptPath", props.scriptPath);
