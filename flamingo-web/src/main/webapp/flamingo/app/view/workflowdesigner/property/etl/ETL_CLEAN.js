 ...
 * ETL Clean
 *
 * @cli hadoop jar flamingo2-mapreduce-hadoop2-2.0.5-job.jar clean --input <IN> --output <OUT> --inputDelimiter ',' --outputDelimiter ',' --columnsToClean '4,5' --columnSize 12
...
Ext.define('Flamingo.view.workflowdesigner.property.etl.ETL_CLEAN', {
    extend: 'Flamingo.view.workflowdesigner.property._NODE_ETL',
    ...
    items: [
        {
            ...
            items: [
                ...
                {
                    xtype: 'textfield',
                    fieldLabel: message.msg('workflow.etl.clean.columnsToClean'),
                    name: 'columnsToClean',
                    emptyText: message.msg('workflow.etl.clean.columnsToCleanEmpty'),
                    regex: /^\d+(,\d+)*$/,
                    allowBlank: false
                },
                {
    ...
    afterPropertySet: function (props) {
        ...
        props.mapreduce.params.push('--columnsToClean', '\'' + props.columnsToClean + '\'');
