...
public interface FileInfo extends Serializable {
     ...
     * 파일 용량기준으로 정렬한다.
     * */
    public static Comparator<FileInfo> LengthComparator = new Comparator<FileInfo>() {
        @Override
     ...
     * 파일명 기준으로 정렬한다.
     * */
    public static Comparator<FileInfo> FilenameComparator = new Comparator<FileInfo>() {
        @Override
        public int compare(FileInfo o1, FileInfo o2) {
            return o1.getFilename().compareTo(o2.toString());
        }
    };
}